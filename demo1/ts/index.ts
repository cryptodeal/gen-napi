...
import type { _Native_Tensor } from './gen_Tensor_methods_shim';
...
export const tensorFromFloat32Array = (v: Float32Array): _Native_Tensor => {
  return addon._tensorFromFloat32Array(v);
};

export const tensorFromFloat64Array = (v: Float64Array): _Native_Tensor => {
  return addon._tensorFromFloat64Array(v);
};

export const tensorFromInt8Array = (v: Int8Array): _Native_Tensor => {
  return addon._tensorFromInt8Array(v);
};

export const tensorFromInt16Array = (v: Int16Array): _Native_Tensor => {
  return addon._tensorFromInt16Array(v);
};

export const tensorFromInt32Array = (v: Int32Array): _Native_Tensor => {
  return addon._tensorFromInt32Array(v);
};

export const tensorFromBigInt64Array = (v: BigInt64Array): _Native_Tensor => {
  return addon._tensorFromBigInt64Array(v);
};

export const tensorFromUint8Array = (v: Uint8Array): _Native_Tensor => {
  return addon._tensorFromUint8Array(v);
};

export const tensorFromUint16Array = (v: Uint16Array): _Native_Tensor => {
  return addon._tensorFromUint16Array(v);
};

export const tensorFromUint32Array = (v: Uint32Array): _Native_Tensor => {
  return addon._tensorFromUint32Array(v);
};

export const tensorFromBigUint64Array = (v: BigUint64Array): _Native_Tensor => {
