...
static Napi::Value _astype(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`astype` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _roll(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`roll` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _transpose(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`transpose` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _clip(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`clip` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _cumsum(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`cumsum` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _arange(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`arange` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _minimum(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`minimum` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _reshape(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`reshape` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _median(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`median` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _norm(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 4) {
    Napi::TypeError::New(env, "`norm` expects exactly 4 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _countNonzero(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 3) {
    Napi::TypeError::New(
        env, "`countNonzero` expects exactly 3 arg, but received s" +
                 std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _any(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`any` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _flip(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`flip` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _power(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`power` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _argmin(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`argmin` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _sum(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`sum` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _var(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 4) {
    Napi::TypeError::New(env, "`var` expects exactly 4 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _all(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`all` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _concatenate(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`concatenate` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _argmax(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`argmax` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _mean(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`mean` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _full(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`full` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _tile(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`tile` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _amin(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`amin` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _amax(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`amax` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _maximum(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`maximum` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _std(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`std` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _where(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 3) {
    Napi::TypeError::New(env, "`where` expects exactly 3 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _lessThan(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`lessThan` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _bitwiseOr(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`bitwiseOr` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _add(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`add` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _mul(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`mul` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _logicalAnd(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`logicalAnd` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _rShift(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`rShift` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _eq(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`eq` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _logicalOr(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`logicalOr` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _greaterThanEqual(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(
        env, "`greaterThanEqual` expects exactly 2 arg, but received s" +
                 std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _sub(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`sub` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _lessThanEqual(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(
        env, "`lessThanEqual` expects exactly 2 arg, but received s" +
                 std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _bitwiseAnd(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`bitwiseAnd` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _div(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`div` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _bitwiseXor(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`bitwiseXor` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _mod(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`mod` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _greaterThan(const Napi::CallbackInfo& info) {
  ...
  if (_arg_count != 2) {
    Napi::TypeError::New(env,
                         "`greaterThan` expects exactly 2 arg, but received s" +
                             std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _lShift(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`lShift` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
...
static Napi::Value _neq(const Napi::CallbackInfo& info) {
  ...
  auto _arg_count = info.Length();
  if (_arg_count != 2) {
    Napi::TypeError::New(env, "`neq` expects exactly 2 arg, but received s" +
                                  std::to_string(_arg_count))
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
