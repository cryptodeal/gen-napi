...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set(Napi::String::New(env, _ "init"), Napi::Function::New(env, init));
  exports.Set(Napi::String::New(env, _ "bytesUsed"),
              Napi::Function::New(env, bytesUsed));
  exports.Set(Napi::String::New(env, _ "setRowMajor"),
              Napi::Function::New(env, setRowMajor));
  exports.Set(Napi::String::New(env, _ "setColMajor"),
              Napi::Function::New(env, setColMajor));
  exports.Set(Napi::String::New(env, _ "isRowMajor"),
              Napi::Function::New(env, isRowMajor));
  exports.Set(Napi::String::New(env, _ "isColMajor"),
              Napi::Function::New(env, isColMajor));
  exports.Set(Napi::String::New(env, _ "dtypeFloat32"),
              Napi::Function::New(env, dtypeFloat32));
  exports.Set(Napi::String::New(env, _ "dtypeFloat64"),
              Napi::Function::New(env, dtypeFloat64));
  exports.Set(Napi::String::New(env, _ "dtypeBoolInt8"),
              Napi::Function::New(env, dtypeBoolInt8));
  exports.Set(Napi::String::New(env, _ "dtypeInt16"),
              Napi::Function::New(env, dtypeInt16));
  exports.Set(Napi::String::New(env, _ "dtypeInt32"),
              Napi::Function::New(env, dtypeInt32));
  exports.Set(Napi::String::New(env, _ "dtypeInt64"),
              Napi::Function::New(env, dtypeInt64));
  exports.Set(Napi::String::New(env, _ "dtypeUint8"),
              Napi::Function::New(env, dtypeUint8));
  exports.Set(Napi::String::New(env, _ "dtypeUint16"),
              Napi::Function::New(env, dtypeUint16));
  exports.Set(Napi::String::New(env, _ "dtypeUint32"),
              Napi::Function::New(env, dtypeUint32));
  exports.Set(Napi::String::New(env, _ "dtypeUint64"),
              Napi::Function::New(env, dtypeUint64));
  exports.Set(Napi::String::New(env, _ "rand"), Napi::Function::New(env, rand));
  exports.Set(Napi::String::New(env, _ "randn"),
