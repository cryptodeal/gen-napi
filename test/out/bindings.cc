...
Napi::Value Tensor::_roll(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`roll` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_where(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`where` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_power(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`power` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_sqrt(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::sqrt(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_erf(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::erf(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_tanh(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::tanh(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_isinf(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::isinf(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_mean(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`mean` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_sin(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::sin(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_flip(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`flip` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_matmul(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (!info[0].IsObject()) {
    Napi::TypeError::New(info.Env(),
                         "`matmul` expects args[0] to be instanceof `Tensor`")
...
Napi::Value Tensor::_norm(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 3) {
    Napi::TypeError::New(info.Env(), "`norm` expects exactly 4 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_transpose(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`transpose` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_nonzero(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::nonzero(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_sort(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`sort` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_maximum(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`maximum` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_sum(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`sum` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_cumsum(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`cumsum` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_countNonzero(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`countNonzero` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_absolute(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::absolute(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_sign(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::sign(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_sigmoid(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::sigmoid(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_isnan(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::isnan(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_reshape(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`reshape` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_tile(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`tile` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_log1p(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::log1p(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_floor(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::floor(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_rint(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::rint(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_amax(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`amax` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_std(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`std` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_all(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`all` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_triu(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  if (g_row_major) {
    _res = fl::tril(*(tensor->_tensor));
...
Napi::Value Tensor::_amin(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`amin` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_any(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`any` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_negative(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::negative(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_log(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::log(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_cos(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::cos(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_ceil(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::ceil(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_clip(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`clip` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_tril(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  if (g_row_major) {
    _res = fl::triu(*(tensor->_tensor));
...
Napi::Value Tensor::_argmin(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`argmin` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_logicalNot(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::logicalNot(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_exp(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  fl::Tensor _res;
  _res = fl::exp(*(tensor->_tensor));
  g_bytes_used += _res.bytes();
...
Napi::Value Tensor::_median(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 2) {
    Napi::TypeError::New(info.Env(), "`median` expects exactly 3 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_var(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 3) {
    Napi::TypeError::New(info.Env(), "`var` expects exactly 4 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_greaterThan(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`greaterThan` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_greaterThanEqual(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(),
                         "`greaterThanEqual` expects exactly 2 args")
...
Napi::Value Tensor::_lessThanEqual(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`lessThanEqual` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_neq(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`neq` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_sub(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`sub` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_div(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`div` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_add(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`add` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_lessThan(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`lessThan` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_bitwiseOr(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`bitwiseOr` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_bitwiseAnd(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`bitwiseAnd` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_rShift(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`rShift` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_bitwiseXor(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`bitwiseXor` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_logicalAnd(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`logicalAnd` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_mul(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`mul` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_eq(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`eq` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_logicalOr(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`logicalOr` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_mod(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`mod` expects exactly 2 args")
        .ThrowAsJavaScriptException();
...
Napi::Value Tensor::_lShift(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  if (info.Length() != 1) {
    Napi::TypeError::New(info.Env(), "`lShift` expects exactly 2 args")
        .ThrowAsJavaScriptException();
