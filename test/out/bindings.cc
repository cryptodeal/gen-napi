...
auto _res = Napi::Value Tensor::copy(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::copy();
  g_bytes_used += _res.bytes();
  auto* out = new fl::Tensor(_res);
  auto _wrapped = Napi::External<fl::Tensor>::New(env, _res);
  Napi::Value wrapped_out = Tensor::constructor->New({wrapped});
  return wrapped_out;
}

auto _res = Napi::Value Tensor::elements(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::elements();
  return Napi::Number::New(env, _res);
}

auto _res = Napi::Value Tensor::ndim(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::ndim();
  return Napi::Number::New(env, _res);
}

auto _res = Napi::Value Tensor::isEmpty(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::isEmpty();
  return Napi::Boolean::New(env, _res);
}

auto _res = Napi::Value Tensor::bytes(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::bytes();
  return Napi::Number::New(env, _res);
}

auto _res = Napi::Value Tensor::type(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::type();
  auto* out = new fl::dtype(_res);
  auto _wrapped = Napi::External<fl::dtype>::New(env, _res);
  Napi::Value wrapped_out = dtype::constructor->New({wrapped});
  return wrapped_out;
}

auto _res = Napi::Value Tensor::strides(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  auto _res = this->_tensor::strides();
  auto* out = new fl::Shape(_res);
  auto _wrapped = Napi::External<fl::Shape>::New(env, _res);
  Napi::Value wrapped_out = Shape::constructor->New({wrapped});
  return wrapped_out;
}

auto _res = Napi::Value Tensor::flatten(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...
auto _res = Napi::Value Tensor::isContiguous(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
