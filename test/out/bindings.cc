...
static Napi::Value _median(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`median` expects args[0] to be `Napi::External<fl::median>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
...
static Napi::Value _negative(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::negative>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
...
static Napi::Value _sin(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sin` expects args[0] to be `Napi::External<fl::sin>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _triu(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`triu` expects args[0] to be `Napi::External<fl::triu>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _matmul(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`matmul` expects args[0] to be `Napi::External<fl::matmul>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  ...
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`matmul` expects args[1] to be `Napi::External<fl::matmul>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
...
static Napi::Value _cumsum(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`cumsum` expects args[0] to be `Napi::External<fl::cumsum>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _any(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`any` expects args[0] to be `Napi::External<fl::any>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _all(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`all` expects args[0] to be `Napi::External<fl::all>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _reshape(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         "`reshape` expects args[0] to be "
                         "`Napi::External<fl::reshape>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _nonzero(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         "`nonzero` expects args[0] to be "
                         "`Napi::External<fl::nonzero>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _floor(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`floor` expects args[0] to be `Napi::External<fl::floor>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _ceil(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`ceil` expects args[0] to be `Napi::External<fl::ceil>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _erf(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`erf` expects args[0] to be `Napi::External<fl::erf>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _mean(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`mean` expects args[0] to be `Napi::External<fl::mean>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _exp(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`exp` expects args[0] to be `Napi::External<fl::exp>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _sqrt(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sqrt` expects args[0] to be `Napi::External<fl::sqrt>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _roll(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`roll` expects args[0] to be `Napi::External<fl::roll>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _sign(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sign` expects args[0] to be `Napi::External<fl::sign>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _tril(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`tril` expects args[0] to be `Napi::External<fl::tril>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _tile(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`tile` expects args[0] to be `Napi::External<fl::tile>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _cos(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`cos` expects args[0] to be `Napi::External<fl::cos>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _tanh(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`tanh` expects args[0] to be `Napi::External<fl::tanh>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _absolute(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::absolute>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _sigmoid(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         "`sigmoid` expects args[0] to be "
                         "`Napi::External<fl::sigmoid>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _clip(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`clip` expects args[0] to be `Napi::External<fl::clip>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`clip` expects args[1] to be `Napi::External<fl::clip>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  ...
  if (!info[2].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`clip` expects args[2] to be `Napi::External<fl::clip>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
...
static Napi::Value _where(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`where` expects args[0] to be `Napi::External<fl::where>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  ...
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`where` expects args[1] to be `Napi::External<fl::where>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  ...
  if (!info[2].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`where` expects args[2] to be `Napi::External<fl::where>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
...
static Napi::Value _argmax(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`argmax` expects args[0] to be `Napi::External<fl::argmax>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _transpose(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::transpose>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _logicalNot(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::logicalNot>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _amin(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`amin` expects args[0] to be `Napi::External<fl::amin>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _argmin(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`argmin` expects args[0] to be `Napi::External<fl::argmin>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _power(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`power` expects args[0] to be `Napi::External<fl::power>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`power` expects args[1] to be `Napi::External<fl::power>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _std(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`std` expects args[0] to be `Napi::External<fl::std>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _log(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`log` expects args[0] to be `Napi::External<fl::log>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _flip(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`flip` expects args[0] to be `Napi::External<fl::flip>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _isnan(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`isnan` expects args[0] to be `Napi::External<fl::isnan>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _minimum(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         "`minimum` expects args[0] to be "
                         "`Napi::External<fl::minimum>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _maximum(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         "`maximum` expects args[0] to be "
                         "`Napi::External<fl::maximum>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _concatenate(const Napi::CallbackInfo& info) {
  ...
  auto axis = axisArg(info[1].As<Napi::Number>().Int32Value(), g_row_major,
                      (&tensors[0])->ndim());
  auto axes = jsArrayArg<Tensor>(info[0].As<Napi::Array>(),
                                 g_row_major, ->_->ndim(), env);
  fl::_res;
...
static Napi::Value _rint(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`rint` expects args[0] to be `Napi::External<fl::rint>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _isinf(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`isinf` expects args[0] to be `Napi::External<fl::isinf>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _amax(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`amax` expects args[0] to be `Napi::External<fl::amax>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _log1p(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`log1p` expects args[0] to be `Napi::External<fl::log1p>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object tensor_obj = info[0].As<Napi::Object>();
...
static Napi::Value _sort(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sort` expects args[0] to be `Napi::External<fl::sort>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _sum(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sum` expects args[0] to be `Napi::External<fl::sum>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _var(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`var` expects args[0] to be `Napi::External<fl::var>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _norm(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`norm` expects args[0] to be `Napi::External<fl::norm>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _countNonzero(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::countNonzero>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object input_obj = info[0].As<Napi::Object>();
...
static Napi::Value _greaterThan(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::greaterThan>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _bitwiseXor(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::bitwiseXor>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _lShift(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`lShift` expects args[0] to be `Napi::External<fl::lShift>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`lShift` expects args[1] to be `Napi::External<fl::lShift>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _mul(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`mul` expects args[0] to be `Napi::External<fl::mul>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`mul` expects args[1] to be `Napi::External<fl::mul>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _bitwiseAnd(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::bitwiseAnd>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _sub(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sub` expects args[0] to be `Napi::External<fl::sub>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`sub` expects args[1] to be `Napi::External<fl::sub>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _logicalOr(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::logicalOr>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _eq(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`eq` expects args[0] to be `Napi::External<fl::eq>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`eq` expects args[1] to be `Napi::External<fl::eq>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _lessThanEqual(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::lessThanEqual>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _neq(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`neq` expects args[0] to be `Napi::External<fl::neq>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`neq` expects args[1] to be `Napi::External<fl::neq>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _lessThan(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::lessThan>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _bitwiseOr(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::bitwiseOr>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _div(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`div` expects args[0] to be `Napi::External<fl::div>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`div` expects args[1] to be `Napi::External<fl::div>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _greaterThanEqual(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::greaterThanEqual>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _logicalAnd(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(info.Env(),
                         ...
                         "`Napi::External<fl::logicalAnd>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
...
static Napi::Value _rShift(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`rShift` expects args[0] to be `Napi::External<fl::rShift>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`rShift` expects args[1] to be `Napi::External<fl::rShift>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _add(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`add` expects args[0] to be `Napi::External<fl::add>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`add` expects args[1] to be `Napi::External<fl::add>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
...
static Napi::Value _mod(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`mod` expects args[0] to be `Napi::External<fl::mod>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object lhs_obj = info[0].As<Napi::Object>();
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
        "`mod` expects args[1] to be `Napi::External<fl::mod>` `Tensor`")
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  Napi::Object rhs_obj = info[1].As<Napi::Object>();
