...
static Napi::Value _arange(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 3) {
		Napi::TypeError::New(info.Env(), "`arange` expects exactly 3 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsNumber()) {
...
static Napi::Value _iota(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`iota` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsArray()) {
	...
	auto dims = jsArrayArg<long long>(info[0].As<Napi::Array>(), g_row_major, false, env);
	if (!info[1].IsArray()) {
		Napi::TypeError::New(info.Env(), "`iota` expects args[1] to be typeof `number[]`").ThrowAsJavaScriptException();
		return env.Null();
	}
	auto tileDims = jsArrayArg<long long>(info[1].As<Napi::Array>(), g_row_major, false, env);
	fl::Tensor _res;
...
static Napi::Value _argmin(const Napi::CallbackInfo& info) {
	...
	if (input_obj.InstanceOf(Tensor::constructor->Value())) {
		Tensor* input = Napi::ObjectWrap<Tensor>::Unwrap(input_obj);
		auto axis = axisArg(info[1].As<Napi::Number>().Uint32Value(), g_row_major, input->_tensor->ndim());
		fl::Tensor _res;
...
static Napi::Value _clip(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 3) {
		Napi::TypeError::New(info.Env(), "`clip` expects exactly 3 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`clip` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object tensor_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`clip` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object low_obj = info[0].As<Napi::Object>();
	if (!info[2].IsObject()) {
		Napi::TypeError::New(info.Env(), "`clip` expects args[2] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object high_obj = info[0].As<Napi::Object>();
	if (tensor_obj.InstanceOf(Tensor::constructor->Value()) && low_obj.InstanceOf(Tensor::constructor->Value()) && high_obj.InstanceOf(Tensor::constructor->Value())) {
		Tensor* tensor = Napi::ObjectWrap<Tensor>::Unwrap(tensor_obj);
...
static Napi::Value _identity(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 1) {
		Napi::TypeError::New(info.Env(), "`identity` expects exactly 1 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsNumber()) {
...
static Napi::Value _maximum(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`maximum` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`maximum` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`maximum` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
...
static Napi::Value _full(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`full` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsArray()) {
	...
	std::vector<long long> dims = jsArrayArg<long long>(info[0].As<Napi::Array>(), g_row_major, false, env);
...
static Napi::Value _minimum(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`minimum` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`minimum` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`minimum` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _matmul(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 1) {
		Napi::TypeError::New(info.Env(), "`matmul` expects exactly 1 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
...
static Napi::Value _sort(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`sort` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
...
static Napi::Value _where(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 3) {
		Napi::TypeError::New(info.Env(), "`where` expects exactly 3 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`where` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object condition_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`where` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object x_obj = info[0].As<Napi::Object>();
	if (!info[2].IsObject()) {
		Napi::TypeError::New(info.Env(), "`where` expects args[2] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object y_obj = info[0].As<Napi::Object>();
	if (condition_obj.InstanceOf(Tensor::constructor->Value()) && x_obj.InstanceOf(Tensor::constructor->Value()) && y_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _power(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`power` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`power` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`power` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _bitwiseXor(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`bitwiseXor` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`bitwiseXor` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`bitwiseXor` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _div(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`div` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`div` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`div` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _rShift(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`rShift` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`rShift` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`rShift` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _logicalAnd(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`logicalAnd` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`logicalAnd` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`logicalAnd` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _greaterThan(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`greaterThan` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`greaterThan` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`greaterThan` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _sub(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`sub` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`sub` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`sub` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _eq(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`eq` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`eq` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`eq` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _logicalOr(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`logicalOr` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`logicalOr` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`logicalOr` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _lessThanEqual(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`lessThanEqual` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`lessThanEqual` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`lessThanEqual` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _lShift(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`lShift` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`lShift` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`lShift` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _lessThan(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`lessThan` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`lessThan` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`lessThan` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _mul(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`mul` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`mul` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`mul` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _greaterThanEqual(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`greaterThanEqual` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`greaterThanEqual` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`greaterThanEqual` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _mod(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`mod` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`mod` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`mod` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _add(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`add` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`add` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`add` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _neq(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`neq` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`neq` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`neq` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _bitwiseOr(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`bitwiseOr` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`bitwiseOr` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`bitwiseOr` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
static Napi::Value _bitwiseAnd(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if (info.Length() != 2) {
		Napi::TypeError::New(info.Env(), "`bitwiseAnd` expects exactly 2 args").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[0].IsObject()) {
		Napi::TypeError::New(info.Env(), "`bitwiseAnd` expects args[0] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object lhs_obj = info[0].As<Napi::Object>();
	if (!info[1].IsObject()) {
		Napi::TypeError::New(info.Env(), "`bitwiseAnd` expects args[1] to be instanceof `Tensor`").ThrowAsJavaScriptException();
		return env.Null();
	}
	Napi::Object rhs_obj = info[0].As<Napi::Object>();
	if (lhs_obj.InstanceOf(Tensor::constructor->Value()) && rhs_obj.InstanceOf(Tensor::constructor->Value())) {
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
	...
	exports.Set(Napi::String::New(env, "_bitwiseXor"), Napi::Function::New(env, _bitwiseXor));
	exports.Set(Napi::String::New(env, "_div"), Napi::Function::New(env, _div));
	exports.Set(Napi::String::New(env, "_rShift"), Napi::Function::New(env, _rShift));
	exports.Set(Napi::String::New(env, "_logicalAnd"), Napi::Function::New(env, _logicalAnd));
	exports.Set(Napi::String::New(env, "_greaterThan"), Napi::Function::New(env, _greaterThan));
	...
	exports.Set(Napi::String::New(env, "_logicalOr"), Napi::Function::New(env, _logicalOr));
	exports.Set(Napi::String::New(env, "_lessThanEqual"), Napi::Function::New(env, _lessThanEqual));
	exports.Set(Napi::String::New(env, "_mul"), Napi::Function::New(env, _mul));
	exports.Set(Napi::String::New(env, "_greaterThanEqual"), Napi::Function::New(env, _greaterThanEqual));
	...
	exports.Set(Napi::String::New(env, "_bitwiseOr"), Napi::Function::New(env, _bitwiseOr));
	exports.Set(Napi::String::New(env, "_lShift"), Napi::Function::New(env, _lShift));
	exports.Set(Napi::String::New(env, "_lessThan"), Napi::Function::New(env, _lessThan));
	exports.Set(Napi::String::New(env, "_bitwiseAnd"), Napi::Function::New(env, _bitwiseAnd));
	return exports;
}
