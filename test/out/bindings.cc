...
static Napi::Value _transpose(const Napi::CallbackInfo& info) {
  ...
  auto axes = jsArrayToVector<long long>(env, info[1].As<Napi::Array>(),
...
static Napi::Value _amin(const Napi::CallbackInfo& info) {
  ...
  auto axes = jsArrayToVector<int>(env, info[1].As<Napi::Array>(), g_row_major,
                                   input->ndim());
  fl::Tensor _res;
...
static Napi::Value _reshape(const Napi::CallbackInfo& info) {
  ...
  auto shape = jsArrayToVector<long long>(env, info[1].As<Napi::Array>(),
                                          g_row_major, false);
  fl::Tensor _res;
...
static Napi::Value _iota(const Napi::CallbackInfo& info) {
  ...
  auto dims = jsArrayToVector<long long>(env, info[0].As<Napi::Array>(),
                                         g_row_major, false);
  if (!info[1].IsArray()) {
  ...
  auto tileDims = jsArrayToVector<long long>(env, info[1].As<Napi::Array>(),
                                             g_row_major, false);
  if (!info[2].IsNumber()) {
