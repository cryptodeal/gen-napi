...
static Napi::Value _tile(const Napi::CallbackInfo& info) {
  ...
  fl::Tensor* fl =
      static_cast<Tensor::tensor>(info[0].As<Napi::External>().Data());
  if (!info[1].IsArray()) {
    Napi::TypeError::New(info.Env(),
...
static Napi::Value _sort(const Napi::CallbackInfo& info) {
  ...
  fl::Tensor* fl =
      static_cast<Tensor::input>(info[0].As<Napi::External>().Data());
  if (!info[1].IsNumber()) {
    Napi::TypeError::New(info.Env(),
...
static Napi::Value _matmul(const Napi::CallbackInfo& info) {
  ...
  fl::Tensor* fl =
      static_cast<Tensor::lhs>(info[0].As<Napi::External>().Data());
  ...
  fl::Tensor* fl =
      static_cast<Tensor::rhs>(info[1].As<Napi::External>().Data());
  fl::Tensor _res;
  if (g_row_major) {
...
static Napi::Value _clip(const Napi::CallbackInfo& info) {
  ...
  fl::Tensor* fl =
      static_cast<Tensor::low>(info[1].As<Napi::External>().Data());
  ...
  fl::Tensor* fl =
      static_cast<Tensor::high>(info[2].As<Napi::External>().Data());
  fl::Tensor _res;
...
static Napi::Value _where(const Napi::CallbackInfo& info) {
  ...
  fl::Tensor* fl =
      static_cast<Tensor::condition>(info[0].As<Napi::External>().Data());
  if (!info[1].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
  ...
  fl::Tensor* fl = static_cast<Tensor::x>(info[1].As<Napi::External>().Data());
  if (!info[2].IsExternal()) {
    Napi::TypeError::New(
        info.Env(),
  ...
  fl::Tensor* fl = static_cast<Tensor::y>(info[2].As<Napi::External>().Data());
  fl::Tensor _res;
