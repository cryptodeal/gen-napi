...
export const eval = (tensor: Tensor) => {
  return _eval(tensor)
}
...
export const tensorFromFloat32Array = (arr: Float32Array): Tensor => {
  return new Tensor(_tensorFromFloat32Array(arr))
}

export const tensorFromFloat64Array = (arr: Float64Array): Tensor => {
  return new Tensor(_tensorFromFloat64Array(arr))
}

export const tensorFromBoolInt8Array = (arr: Int8Array): Tensor => {
  return new Tensor(_tensorFromBoolInt8Array(arr))
}

export const tensorFromInt16Array = (arr: Int16Array): Tensor => {
  return new Tensor(_tensorFromInt16Array(arr))
}

export const tensorFromInt32Array = (arr: Int32Array): Tensor => {
  return new Tensor(_tensorFromInt32Array(arr))
}

export const tensorFromInt64Array = (arr: BigInt64Array): Tensor => {
  return new Tensor(_tensorFromInt64Array(arr))
}

export const tensorFromUint8Array = (arr: Uint8Array): Tensor => {
  return new Tensor(_tensorFromUint8Array(arr))
}

export const tensorFromUint16Array = (arr: Uint16Array): Tensor => {
  return new Tensor(_tensorFromUint16Array(arr))
}

export const tensorFromUint32Array = (arr: Uint32Array): Tensor => {
  return new Tensor(_tensorFromUint32Array(arr))
}

export const tensorFromUint64Array = (arr: BigUint64Array): Tensor => {
