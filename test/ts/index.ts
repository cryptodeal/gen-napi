...
export const tensorFromFloat32Buffer = (arr: Float32Array): any => {
  return _tensorFromFloat32Buffer(arr)
}

export const tensorFromFloat64Buffer = (arr: Float64Array): any => {
  return _tensorFromFloat64Buffer(arr)
}

export const tensorFromBoolInt8Buffer = (arr: Int8Array): any => {
  return _tensorFromBoolInt8Buffer(arr)
}

export const tensorFromInt16Buffer = (arr: Int16Array): any => {
  return _tensorFromInt16Buffer(arr)
}

export const tensorFromInt32Buffer = (arr: Int32Array): any => {
  return _tensorFromInt32Buffer(arr)
}

export const tensorFromInt64Buffer = (arr: BigInt64Array): any => {
  return _tensorFromInt64Buffer(arr)
}

export const tensorFromUint8Buffer = (arr: Uint8Array): any => {
  return _tensorFromUint8Buffer(arr)
}

export const tensorFromUint16Buffer = (arr: Uint16Array): any => {
  return _tensorFromUint16Buffer(arr)
}

export const tensorFromUint32Buffer = (arr: Uint32Array): any => {
  return _tensorFromUint32Buffer(arr)
}

export const tensorFromUint64Buffer = (arr: BigUint64Array): any => {
  return _tensorFromUint64Buffer(arr)
}
