...
static Napi::Value sum(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`sum` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value mean(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`mean` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value norm(const Napi::CallbackInfo& info) {
	...
	if (!info[3].()) {
		Napi::TypeError::New(info.Env(), "`norm` expects args[3] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value argmax(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`argmax` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value median(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`median` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value amin(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`amin` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value amax(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`amax` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value std(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`std` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value countNonzero(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`countNonzero` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value any(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`any` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value all(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`all` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value var(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`var` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	if (!info[3].()) {
		Napi::TypeError::New(info.Env(), "`var` expects args[3] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
...
static Napi::Value argmin(const Napi::CallbackInfo& info) {
	...
	if (!info[2].()) {
		Napi::TypeError::New(info.Env(), "`argmin` expects args[2] to be typeof ``").ThrowAsJavaScriptException();
		return env.Null();
	}
	return env.Null();
}
