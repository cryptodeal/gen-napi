...
static Napi::Value _bar(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsTypedArray()) {
    Napi::TypeError::New(
        env, "`bar` expects `a` (args[0]) to be instanceof `Float64Array`")
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
  if (!info[1].IsNumber()) {
...
static Napi::Value _baz(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsTypedArray()) {
    Napi::TypeError::New(
        env, "`baz` expects `a` (args[0]) to be instanceof `Float32Array`")
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
  if (!info[1].IsNumber()) {
...
static Napi::Value _test3(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsTypedArray()) {
    Napi::TypeError::New(
        env, "`test3` expects `a` (args[0]) to be instanceof `Float64Array`")
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
  Napi::TypedArrayOf<double> _gen_tmp_a =
...
static Napi::Value _test5(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsTypedArray()) {
    Napi::TypeError::New(
        env, "`test5` expects `a` (args[0]) to be instanceof `Float64Array`")
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
  Napi::TypedArrayOf<double> _gen_tmp_a =
...
static Napi::Value _qux(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsTypedArray()) {
    Napi::TypeError::New(
        env, "`qux` expects `a` (args[0]) to be instanceof `BigInt64Array`")
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
  if (!info[1].IsNumber()) {
...
static Napi::Value _test2(const Napi::CallbackInfo& info) {
  ...
  if (!info[0].IsTypedArray()) {
    Napi::TypeError::New(
        env, "`test2` expects `a` (args[0]) to be instanceof `Float64Array`")
        .ThrowAsJavaScriptException();
    return env.Undefined();
  }
  Napi::TypedArrayOf<double> _gen_tmp_a =
